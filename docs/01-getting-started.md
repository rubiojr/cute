...
```ruby
require "github.com/rubiojr/cute@v0.2.0"
...
Cute is a Rugo module — you load it with `require "github.com/rubiojr/cute@v0.2.0"` and call its functions through the `cute` namespace.
